...
Goblend is a [Blender](https://www.blender.org) addon and a [Godot](https://godotengine.org) addon that allows you to export your Blender scenes into Godot with a click of a button. Its features include:
...
For documentation, visit [goblend.dev](https://goblend.dev).

## Installation

Installation instructions can also be found in the documentation, this is the [direct link](https://goblend.dev/docs/installation).

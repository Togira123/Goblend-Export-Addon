...
def is_collision_collection(self, collection):
    ...
    return (collection == collision_collection or collection in collision_collection.children_recursive) and not collection in existing
...
class CollisionPanelProperties(bpy.types.PropertyGroup):
    ...
    layers_override_enabled: bpy.props.BoolProperty(
        name="Override Collision Layers",
        default=False
    )
    ...
    masks_override_enabled: bpy.props.BoolProperty(
        name="Override Collision Masks",
        default=False
    )
    ...
    groups_override_enabled: bpy.props.BoolProperty(
